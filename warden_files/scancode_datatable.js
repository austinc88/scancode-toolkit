...
function ScancodeDataTable(tagId, data){
    ...
    var licenseData = toLicenseFormat(data);
    var copyrightData = toCopyrightFormat(data);
    ...
    // Return license and copyright data in table format
    function toLicenseFormat(jsonData){
        return $.map(jsonData, function(x){
            // Add all license columns here
            licenseData = [];
            if('licenses' in x) {
    ...
    // Return license and copyright data in table format
    function toCopyrightFormat(jsonData){
        return $.map(jsonData, function(x){
            // Add all copyright columns here
            copyrightData = [];
            if('copyrights' in x) {
